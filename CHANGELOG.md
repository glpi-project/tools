...
## [0.8.4] - 2026-09-09
- Add support for playwright files
- Exclude headers check from tests directories
...
## [0.7.6] - 2025-07-31
- Use the `ustar` tar format for plugin archives to prevent [issues with long paths](https://github.com/php/php-src/issues/19311).
